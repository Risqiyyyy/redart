...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
            ...
            <div class="-mx-4 flex flex-wrap items-center">
              <div class="w-full px-4">
                ...
                >
                  ...
                  >
                  Layanan Pengembangan Situs Web, Desain Grafis, Infografis, Animasi 2d, dan  Visual Branding yang Berkualitas
                  </p>
                </div>
              </div>
            ...
            <div class="-mx-4 flex flex-wrap">
              <div class="w-full px-4">
                <div class="mb-12 max-w-[620px] lg:mb-20">
                  ...
                  >
                   Layanan yang kami kembangkan meliputi semua kebutuhan IT anda .
                  </p>
                </div>
              </div>
            </div>
            <div class="-mx-4 flex flex-wrap">
              <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".1s">
                  ...
                  <p class="mb-8 text-body-color lg:mb-11">
                    Situs web seperti Portfolio, E-Commerce, dan sebagainya.
                  </p>
                  <a
              ...
              <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                ...
                >
                  ...
                  <h4 class="mb-3 text-xl font-bold text-dark">
                    Desain Logo, Banner, Poster, Iklan
                  </h4>
                  <p class="mb-8 text-body-color lg:mb-11">
                    Membuat Desain logo, Banner, Poster, dan Iklan yang anda butuhkan .
                  </p>
                  <a
                    href="javascript:void(0)"
                    class="text-base font-medium text-body-color hover:text-primary"
              ...
              <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".2s">
                  ...
                  <p class="mb-8 text-body-color lg:mb-11">
                    Visual Branding adalah aspek penting dari strategi pemasaran Anda yang akan kami bantu.
                  </p>
                  <a
                    href="javascript:void(0)"
                    class="text-base font-medium text-body-color hover:text-primary"
              ...
              <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                ...
                >
                  ...
                  <p class="mb-8 text-body-color lg:mb-11">
                    Animasi 2D adalah animasi yang menggunakan sketsa gambar yang kalian inginkan.
                  </p>
                  <a
                    href="javascript:void(0)"
                    class="text-base font-medium text-body-color hover:text-primary"
              ...
              <div class="w-full px-4">
                <div class="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
                  ...
                  <p
                    class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed"
                  >
                    Ada beberapa harga paket yang anda butuhkan dari produk yang anda ingin kembangkan.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="w-full px-4">
                <div class="mx-auto mb-[60px] max-w-[620px] text-center">
                  ...
                  <p
                    class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed"
                  >
                  Beberapa team pengembang kami yang bertanggung jawab atas semua yang
                  kami kembangkan untuk kebutuhan anda.
                  </p>
                </div>
              </div>
            </div>
        ...
        <footer
          class="wow fadeInUp z-10 bg-black lg:pt-[80px]">
                ...
                <div class="w-full px-4 md:w-2/3 lg:w-1/2">
                  <div class="my-1">
                    ...
                    >
                      ...
                      >
                      Copyright © 2023 Re|Dart Development
                      </a>
                    </div>
                  </div>
                </div>
